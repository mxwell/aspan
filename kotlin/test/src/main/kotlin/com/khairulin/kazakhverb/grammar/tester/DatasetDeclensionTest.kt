...
/**
 * Usage:
 *   $ ./gradlew :test:run --args="DatasetDeclension /home/murat/git/aspan/data/dict/noun.detect_suggest_forms.20250204.jsonl"
 */

class DatasetDeclensionTest(val resourcePath: String) {
